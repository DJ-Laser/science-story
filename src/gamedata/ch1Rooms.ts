    ...
    questions: [
      {
        ...
        result:
          'J Robert Oppenheimer: "The Manhattan project is a secret project working on developing weapons capable of ending the war in favor of the allies. Scientists from both Canada and The United Kindoms have joined us to work on this project. The Manhattan project is not the first project researching atomic weapons, as far as we can tell the Germans have gotten nowhere since they started."',
      },
      {
      ...
      },
      {
        ...
        result:
          'J Robert Oppenheimer: "Nuclear energy is the energy generated when atoms split apart, the two ways this is generated is fusion or fission. Fusion refers to the merging of two lighter atoms into heavier atoms, and Fission is the opposite, splitting one heavier atom into two smaller atoms. This causes a chain reaction that will generate huge amounts of energy. This is because the process releases neutrons that will collide with other atoms causing the same process to occur."',
      },
      {
